...
print(os.getcwd())
os.chdir('/boot3/bio_gaoyueying/Study/RBP/disease299/test')
print(os.getcwd())
...
path = "/boot3/bio_gaoyueying/Study/RBP/disease299/disease299"
...
if __name__ == '__main__':
    ...
    filname=gene_file_1.split('.')[0]+'_'+'_results.txt'
...
for i in range(0,len(files)):
    if __name__ == '__main__':
        ...
        if gene_file_1 == 'none' or gene_file_2 == 'none':
            ...
            ./disease_distance.py --g1 MS.txt --g2 PD.txt

            For more information, type
            ./disease_distance.py --usage
